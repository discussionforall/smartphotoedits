export const SuccessStoryData = [
       {
        ...
        {
            "title" : "Processing Capacity Increases to 3 Million Images Per Annum for a Norway-based Photo Editing Firm with 50% Cost Savings",
            "scope": "The client needed to process 1 million images each year – a challenging task as they lacked the required infrastructure and resources.",
        ...
        {
            "title" : "1,000 Real Estate Images Manually Edited with 65% Cost Savings for American 3D Tour Provider",
            "scope": "The client requested 1,000 real estate images to be manually edited using Photoshop, plugged into Lightroom, and the background skies in all the images to be replaced – all within 24 hours.",
        ...
        },  
        {
            ...
            "country" : [ "Netherlands", "United Kingdom", "Italy", "Belgium", "France", "Ireland"]
        },  
        {
            "title" : "50,000 Images Processed Per Annum for a Real Estate Firm in Denmark with 40-60% Cost Savings",
            "scope": "The client needed to cost-effectively produce 50,000 high-quality images every year with round-the-clock image editing coverage and a TAT of 14 hours. A 99% error-free output was set as the benchmark.",
        ...
        },  
        {
            ...
            "country" : [ "Denmark", "United Kingdom", "Italy", "Belgium", "France", "Ireland", "Singapore"]
        }, 
        {
        ...
        {
            "title" : "70% Cost Reduction with SPE's Image Enhancement and Retouching Services for a Los Angeles Jeweler",
            "scope": "The client wanted 1,000 images to be clipped, retouched and enhanced, every week. An added caveat was that at least 200 images had to be processed every single day. ",
            "outcome": "Spectacularly enhanced and edited jewelry images delivered successfully within the set time frame to the client with an added benefit of a 70% reduction in costs.",
