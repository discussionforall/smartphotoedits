  ...
  <div className="about-main-div">
         ...
         <div className="abot-2-sec">
            <div className="row">
                <div className="col-md-6">
                  <div className="img-box-about">
                     <img src={About_1} class="desktop-img-1" width="528px" height="419px"></img>
                     <img src={About_1_mob} class="mob-img-1" width="366px" height="290px"></img>
                  </div>
                </div>
                <div className="col-md-6">
                   <p>Smart Photo Edits is a photo editing service provider that
                      serves the needs of photographers, photo studios, and
                      several other businesses in their image editing
                      requirements. We are a team of highly skilled editors
                      based in Bangalore, India.
                    </p>
                    <p>
                        Since 2006, we have been collaborating with customers
                        from across the world in industries ranging from fashion
                        to real estate, jewelry, clothing, portraits, retail products,
                        and many more. Having worked with some of the world’s
                        most leading names in the photography world, we have
                        gained a proper, in-depth understanding of what
                        photographers and photo studios genuinely need to
                        take their photographs to the next level. 
                    </p>
          ...
          <div className="abot-2-sec secound-ab">
            <div className="row">
                ...
                <div className="col-md-6">
                   <p>We focus on delivering premium quality services at an
                      affordable price. We have developed flexible
                      engagement plans so our customers can enjoy our
                      services at a price that works best for them. Our
                      attention to detail, dedicated team of experts, and
                      thirst to deliver tangible results are what set us apart
                      in the photo editing world.
                    </p>
                    <div className="check-sec-about">
                       <div className="check-img-about">
                          <img src={check_img} width="35px" height="35px"></img>
                       </div>
                ...
                <div className="col-md-6">
                  <div className="img-box-about">
                     <img src={About_2} class="desktop-img-1" width="528px" height="418px"></img>
                     <img src={About_2_mob} class="mob-img-1" width="366px" height="290px"></img>
                  </div>
                </div>
             </div>
          </div> 
      ...
      <div className="about-3-sec">
             <div className="container">
                <div className="row">
                   <div className="col-md-6">
                     <img src={our_mission} class="desktop-img-1" width="629px" height="470px"></img>
                     <img src={our_mission_mob} class="mob-img-1" width="340px" height="254px"></img>
                   </div>
                   <div className="col-md-6 our-mission">
                      <div class="cat-slider-text">
                          ...
                          <p>SPE’s mission is to deliver cost-effective photo editing
                            ...
                            photographers, and photo studios in the USA, Canada,
                            UK, Europe, and Australia.
                          </p>
                          <p>We work with a customer-first attitude, focusing on
                          delivering uncompromising quality and security in
                          each project. We have designed our processes to
                          ensure on-time, in-full delivery with thorough quality
                          checks at each stage, delighting our customers every
                          single time. 
                          </p>
                        </div>
                   </div>
                  ...
                  <div className="row">
                      <div className="col-lg-9 col-md-12">
                          <div className="cat-slider-text">
                            ...
                            <h2>Our Key <br></br> Differentiators</h2>
                            <p>Some of the things that set us apart from our competitors are </p>
                          </div>
                      </div>
