                  ...
                  <div className="row">
                    <div className="col-lg-6">
                      <div className="text-box">
                        <h1>{dataKey&&dataKey?dataKey: Real_Estate_keyword}</h1>
                      
                        <p>Make your property listings stand out in a competitive market by partnering 
                          with Smart Photo Edits, for {dataKey&&dataKey?dataKey: Real_Estate_keyword}. 
                        ...
                        <Link to="/contact" className="get-started">
                          ...
                          <Link to="/portfolio?tab=0" className="see-port">see portfolio </Link>
                        </div>
...
editing outsourcing partner for businesses in {locationKey&&locationKey?locationKey:'United States'}.
                          ...
                          <p> We’ve worked with real estate agents, developers,
                              ...
                              {dataKey&&dataKey?dataKey: Real_Estate_keyword}, we are the ideal partner for you. 
                          </p>
                        </div>
                   </div>
                </div>
...
for  {dataKey&&dataKey?dataKey: Real_Estate_keyword} in {locationKey&&locationKey?locationKey:'United States'} will end with a
