        ...
        <div className="slider-main">
            <Slider {...settings}>
                <div>
                    <div className="cate-slider-box">
                        <div className="back-color-slider-box">
                            <div className="icon-sec-slider color-1"> <img src={key1} alt="OurKey-img-1" width="49px" height="38px"></img>
                            </div>
                ...
                <div>
                    <div className="cate-slider-box">
                        <div className="back-color-slider-box">
                            <div className="icon-sec-slider color-2"> <img src={key2} alt="OurKey-img-2" width="40px" height="46px"></img>
                            </div>
                            <h1>ISO Quality </h1>
                ...
                <div>
                    <div className="cate-slider-box">
                        <div className="back-color-slider-box">
                            <div className="icon-sec-slider color-1"> <img src={key3} alt="OurKey-img-3" width="48px" height="48px"></img>
                            </div>
                ...
                <div>
                    <div className="cate-slider-box">
                        <div className="back-color-slider-box">
                            <div className="icon-sec-slider color-2"> <img src={key4} alt="OurKey-img-4" width="48px" height="48px"></img>
                            </div>
