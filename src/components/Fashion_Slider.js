  ...
  <div>
        ...
        <Slider {...settings}>
          <div>
            <div className="cate-slider-box">
                <div className="back-color-slider-box">
                   <img src={fashion_slider_1} alt="fashion-slider-img-1" width="554px" height="552px"></img>
          ...
          <div>
            <div className="cate-slider-box">
                <div className="back-color-slider-box">
                    <img src={fashion_slider_2} alt="fashion-slider-img-2" width="554px" height="552px"></img> 
                    <div className="fh-text">        
          ...
          <div>
                <div className="cate-slider-box">
                    <div className="back-color-slider-box">
                        <img src={fashion_slider_3} alt="fashion-slider-img-3" width="554px" height="552px"></img>
                        <div className="fh-text">
